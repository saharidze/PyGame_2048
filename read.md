# Оглавление
1. [Модуль общих мутаций для взаимодействия с сущностями авторизации пользователей](#loginuser-класс-мутации-на-авторизацию-пользователя)
2. [Модуль мутаций создания для взаимодействия с сущностями авторизации пользователей](#createpackofuserbyfile-класс-мутации-на-создание-файла-с-группами-пользователей)
3. [Модуль мутаций удаления для взаимодействия с сущностями авторизации пользователей](#deleteusermutation-класс-мутации-на-удаление-пользователя)
4. [Модуль мутаций обновления для взаимодействия с сущностями авторизации пользователей](#updateuser-класс-мутации-на-обновление-пользователя)
5. [Модуль запросов для взаимодействия с сущностями типа авторизации пользователей](#allusers-получение-пользователей)
6. [Модуль мутаций создания для взаимодействия с сущностями машин](#registerinterval-класс-мутации-на-регистрацию-интервала-тис)
7. [Модуль мутаций удаления для взаимодействия с сущностями машин](#deleteroutelist-класс-мутации-на-удаление-путевого-листа)
8. [Модуль мутаций обновления для взаимодействия с сущностями машин](#updatefuelconsumption-класс-мутации-на-обновление-причины-расхода-топлива)
9. [Модуль запросов для взаимодействия с сущностями машин](#getallmachine-получение-машин)
10. [Модуль общих мутаций для взаимодействия с сущностями контрактов](#transferstatementposition-класс-мутации-на-перенос-позиций-ведомости)
11. [Модуль мутаций создания для взаимодействия с сущностями контрактов](#createcontractstatement-класс-мутации-на-создание-контракта)
12. [Модуль мутаций удаления для взаимодействия с сущностями контрактов](#deletecontract-класс-мутации-на-удаление-контракта)
13. [Модуль мутаций обновления для взаимодействия с сущностями контрактов](#updatecontractstatementcolumn-класс-мутации-на-обновление-дополнительного-столбца-ведомости-контракта)
14. [Модуль запросов для взаимодействия с сущностями типа доступа контрактов](#getcontractsbyprojectid-получение-контракта-по-идентификатору-проекта)
15. [Модуль мутаций создания для взаимодействия с сущностями маяков](#createmarker-класс-мутации-на-создание-маяка)
...
[Модуль общих мутаций для взаимодействия с сущностями авторизации пользователей](#loginuser-класс-мутации-на-авторизацию-пользователя)
